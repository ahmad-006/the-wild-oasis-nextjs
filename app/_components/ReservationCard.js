    ...
    <div className="flex md:flex-row flex-col border border-primary-800">
      ...
      <div className="flex-grow px-6 py-3 flex flex-col">
        ...
        <div className="flex gap-5 mt-auto items-baseline">
          <p className="md:text-xl text-lg font-semibold text-accent-400">${totalPrice}</p>
      ...
      <div className="flex flex-col md:border-l border-t border-primary-800 md:w-[100px] w-full">
        <a
